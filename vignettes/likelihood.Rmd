...
newParam = c(theta=9.818182, c=1.616162)
continousTime = seq(0,1,length.out=100)
newVolume <- model(newParam,continousTime)

# 
plotFunction_Data(continousTime,newVolume,phosphorous,x_label = "Hours",y_label = "Volume")
