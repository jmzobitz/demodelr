...
Additionally because we have a differential equation, we need to specify the times that these measurements occur and the initial condition
...
```{r, fig.show='hold'}
mcmcEstimate(input_data,"time",parameters,lower_bound,upper_bound,iterations,burn_percentage) 
```
