---
title: "Solving Differential Equations Numerically"
author: "John M. Zobitz"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Solving Differential Equations Numerically}
...
These numerical solvers are beyond the scope of this course, but if you want more info, you can read about them here [here](https://cran.r-project.org/web/packages/deSolve/vignettes/deSolve.pdf).  This links you to a vignette from the package deSolve, from which I adapted this code. 
